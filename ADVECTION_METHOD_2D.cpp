...
template<class TT>
void ADVECTION_METHOD_2D<TT>::SL1stOrder(FIELD_STRUCTURE_2D<TT>& rho, FIELD_STRUCTURE_2D<TT>& rho_ghost, const FIELD_STRUCTURE_2D<VT>& velocity, const T& dt)
{
...
template<class TT>
void ADVECTION_METHOD_2D<TT>::SL1stOrder(LEVELSET_2D& rho, FIELD_STRUCTURE_2D<TT>& rho_ghost, const FIELD_STRUCTURE_2D<VT>& velocity, const T& dt)
{
	const ARRAY_2D<VT>& velocity_array(velocity.array_for_this);
...
//template<class TT>
//void ADVECTION_METHOD_2D<TT>::Gradient_Augmented_Method(LEVELSET_2D& rho, FIELD_STRUCTURE_2D<TT>& rho_ghost, const FIELD_STRUCTURE_2D<VT>& velocity, const T& dt)
//{
//	const ARRAY_2D<VT>& velocity_array(velocity.array_for_this);
...
//// WENO 5th 
//template<class TT>
//void ADVECTION_METHOD_2D<TT>::WENO5th(FIELD_STRUCTURE_2D<TT>& rho, FIELD_STRUCTURE_2D<TT>& rho_ghost, const FIELD_STRUCTURE_2D<VT>& velocity, const T& dt, const T& epsilon)
//{
//	ARRAY_2D<TT>& rho_array(rho.array_for_this);
//
...
//template<class TT>
//void ADVECTION_METHOD_2D<TT>::WENO5th(FIELD_STRUCTURE_2D<TT>& rho, FIELD_STRUCTURE_2D<TT>& rho_ghost, const FIELD_STRUCTURE_2D<TT>& velocity_x, const FIELD_STRUCTURE_2D<TT>& velocity_y, const T& dt, const T& epsilon)
//{
...
//
//template<class TT>
//void ADVECTION_METHOD_2D<TT>::WENO5th(FIELD_STRUCTURE_2D<TT>& rho, FIELD_STRUCTURE_2D<TT>& rho_ghost, const FIELD_STRUCTURE_2D<TT>& velocity_x, const FIELD_STRUCTURE_2D<TT>& velocity_y, const T& dt, const T& epsilon, MULTITHREADING& multithreading, const int& thread_id)
//{
//	const ARRAY_2D<TT>& velocity_array_x(velocity_x.array_for_this);
//	const ARRAY_2D<TT>& velocity_array_y(velocity_y.array_for_this);
//	ARRAY_2D<TT>& rho_array(rho.array_for_this);
...
//
//template<class TT>
//void ADVECTION_METHOD_2D<TT>::WENO5thReinitialization(FIELD_STRUCTURE_2D<TT>& rho, FIELD_STRUCTURE_2D<TT>& rho_ghost, const T& dt, const T& epsilon, const FIELD_STRUCTURE_2D<T>& sign_function)
//{
//	ARRAY_2D<TT>& rho_array(rho.array_for_this);
//
//	rho_ghost.FillGhostCellsFrom(rho_array, true);
...
//
//template<class TT>
//void ADVECTION_METHOD_2D<TT>::GodunovReinitialization(FIELD_STRUCTURE_2D<TT>& rho, FIELD_STRUCTURE_2D<TT>& rho_ghost, const T& dt, const T& epsilon, const FIELD_STRUCTURE_2D<T>& sign_function, const FIELD_STRUCTURE_2D<T>& phi_0)
//{
//	ARRAY_2D<TT>& rho_array(rho.array_for_this);
//
//	rho_ghost.FillGhostCellsContinuousDerivativesFrom(rho_array, true);
...
//
//template<class TT>
//void ADVECTION_METHOD_2D<TT>::SubcellFixedReinitialization(FIELD_STRUCTURE_2D<TT>& rho, FIELD_STRUCTURE_2D<TT>& rho_ghost, const T& dt, const T& epsilon, const FIELD_STRUCTURE_2D<T>& sign_function, const FIELD_STRUCTURE_2D<T>& phi_0)
//{
//	ARRAY_2D<TT>& rho_array(rho.array_for_this);
//
//	rho_ghost.FillGhostCellsContinuousDerivativesFrom(rho_array, true);
...
//
//template<class TT>
//void ADVECTION_METHOD_2D<TT>::WENO5thReinitialization(FIELD_STRUCTURE_2D<TT>& rho, FIELD_STRUCTURE_2D<TT>& rho_ghost, const T& dt, const T& epsilon, const FIELD_STRUCTURE_2D<T>& sign_function, MULTITHREADING& multithreading, const int& thread_id)
//{
//	ARRAY_2D<TT>& rho_array(rho.array_for_this);
//
//	rho_ghost.FillGhostCellsFrom(rho_array, true, thread_id);
...
//// ENO3rd Method
//template<class TT>
//void ADVECTION_METHOD_2D<TT>::ENO3rd(FIELD_STRUCTURE_2D<TT>& rho, FIELD_STRUCTURE_2D<TT>& rho_ghost, const FIELD_STRUCTURE_2D<VT>& velocity, const T& dt)
//{
//	const ARRAY_2D<VT>& velocity_array(velocity.array_for_this);
//	ARRAY_2D<TT>& rho_array(rho.array_for_this);
//
...
//template<class TT>
//void ADVECTION_METHOD_2D<TT>::ENO3rd(FIELD_STRUCTURE_2D<TT>& rho, FIELD_STRUCTURE_2D<TT>& rho_ghost, const FIELD_STRUCTURE_2D<TT>& velocity_x, const FIELD_STRUCTURE_2D<TT>& velocity_y, const T& dt)
//{
//	const ARRAY_2D<TT>& velocity_array_x(velocity_x.array_for_this);
//	const ARRAY_2D<TT>& velocity_array_y(velocity_y.array_for_this);
//
...
//
//template<class TT>
//void ADVECTION_METHOD_2D<TT>::ENO3rd(FIELD_STRUCTURE_2D<TT>& rho, FIELD_STRUCTURE_2D<TT>& rho_ghost, const FIELD_STRUCTURE_2D<TT>& velocity_x, const FIELD_STRUCTURE_2D<TT>& velocity_y, const T& dt, MULTITHREADING& multithreading, const int& thread_id)
//{
//	const ARRAY_2D<TT>& velocity_array_x(velocity_x.array_for_this);
//	const ARRAY_2D<TT>& velocity_array_y(velocity_y.array_for_this);
//
