...
void PCG_METHOD::Intialize(const T& tolerance_input, const int& max_iteration_input, MULTITHREADING* multithreading_input)
{
	BASE::Initialize(tolerance_input, max_iteration_input, multithreading_input);
}

// Member Function
void PCG_METHOD::Solve(const CSR_MATRIX<T>& A, VECTOR_ND<T>& x, const VECTOR_ND<T>& b, const FIELD_STRUCTURE_2D<int>& bc)
{
	PCGMethod(bc.grid.i_res, bc.grid.j_res, A, x, b);
}

void PCG_METHOD::Solve(const CSR_MATRIX<T>& A, VECTOR_ND<T>& x, const VECTOR_ND<T>& b, const FIELD_STRUCTURE_2D<int>& bc, const int& thread_id)
{
	PCGMethod(bc.grid.i_res, bc.grid.j_res, A, x, b, thread_id);
}

// Preconditioner as a diagonal matrix - easiest one but mediocre 
void PCG_METHOD::MultiplicationByMinverseAsDiagonal(const CSR_MATRIX<T>& A, VECTOR_ND<T>& x, const VECTOR_ND<T>& b)
{
	const int N = A.N;
...
void PCG_METHOD::MultiplicationByMinverseAsDiagonal(const CSR_MATRIX<T>& A, VECTOR_ND<T>& x, const VECTOR_ND<T>& b, const int& thread_id)
{
	const int N = A.N;
...
void PCG_METHOD::MultiplicationByMinverse(const int& i_res_input, const int& j_res_input, const CSR_MATRIX<T>& M, VECTOR_ND<T>& x, const VECTOR_ND<T>& b)
{
...
void PCG_METHOD::MultiplicationByMinverse(const int& i_res_input, const int& j_res_input, const CSR_MATRIX<T>& M, VECTOR_ND<T>& x, const VECTOR_ND<T>& b, const int& thread_id)
{
	BEGIN_HEAD_THREAD_WORK
	{
		y.Initialize(x.num_dimension, true);
...
void PCG_METHOD::PCGMethod(const int& i_res_input, const int& j_res_input, const CSR_MATRIX<T>& A, VECTOR_ND<T>& x, const VECTOR_ND<T>& b)
{
...
void PCG_METHOD::PCGMethod(const int& i_res_input, const int& j_res_input, const CSR_MATRIX<T>& A, VECTOR_ND<T>& x, const VECTOR_ND<T>& b, const int& thread_id)
{
	BEGIN_HEAD_THREAD_WORK
	{
...
void PCG_METHOD::SplitDomainIndex1DinXDirection(const int& i_start, const int& i_res)
{
...
void PCG_METHOD::SplitDomainIndex1DinYDirection(const int& j_start, const int& j_res)
{
	const int num_threads = multithreading->num_threads;
...
int PCG_METHOD::GlobalCoordinateForRedBlockLeftLowerCorner(const int& thread_id, const int& order, const int& direction)
{
	// x-direction
	if (direction == (int)1)
	{
...
int PCG_METHOD::GlobalCoordinateForBlackBlockLeftLowerCorner(const int& thread_id, const int& order, const int& direction)
{
	// x-direction
	if (direction == (int)1)
	{
...
int PCG_METHOD::GlobalCoordinateForRedBlockLeftUpperCorner(const int& thread_id, const int& order, const int& direction)
{
	// x-direction
	if (direction == (int)1)
	{
...
int PCG_METHOD::GlobalCoordinateForRedBlockRightLowerCorner(const int& thread_id, const int& order, const int& direction)
{
	// x-direction
	if (direction == (int)1)
	{
...
int PCG_METHOD::GlobalCoordinateForRedBlockRightUpperCorner(const int& thread_id, const int& order, const int& direction)
{
	// x-direction
	if (direction == (int)1)
	{
...
int PCG_METHOD::GlobalCoordinateForBlackBlockRightUpperCorner(const int& thread_id, const int& order, const int& direction)
{
	// x-direction
	if (direction == (int)1)
	{
...
void PCG_METHOD::ForwardSubstitution(const int& thread_id, const int& i_res_input, const CSR_MATRIX<T>& M, VECTOR_ND<T>& x, const VECTOR_ND<T>& b)
{
